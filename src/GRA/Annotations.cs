namespace GRA
{
    public static class Annotations
    {
        ...
        public static class Interface
        {
            ...
            public const string EmailDefaultFooter = "You are receiving this email because you are subscribed for updates from {{Sitename}}. You can [unsubscribe instantly at any time]({{UnsubscribeLink}})";
