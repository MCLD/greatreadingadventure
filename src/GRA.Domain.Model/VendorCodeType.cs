...
namespace GRA.Domain.Model
{
    public class VendorCodeType : Abstract.BaseDomainEntity
    {
        ...
        [MaxLength(255)]
        [Display(Description = "URL to redeem a vendor-code based prize, {BranchId} will be replace with the participant's branch id, {{Code}} will be replaced with the vendor code")]
