# Get build image
FROM mcr.microsoft.com/dotnet/sdk:5.0@sha256:3ca1a372ff025d1f84bb2bef7dbb7c284ea3b49e00bcd0047336b9bca9f8dfb7 AS build
WORKDIR /app
...
# Get runtime image
FROM mcr.microsoft.com/dotnet/aspnet:5.0@sha256:2e8b004390a197a2dde8c0e5a958c42049b6207e66c7440b9295b9858151c891 AS publish
WORKDIR /app
