        ...
        <table width="100%" cellpadding="5" cellspacing="0">
            ...
            <asp:Repeater runat="server" ID="rptr" onitemcommand="rptr_ItemCommand" >
                <ItemTemplate>            
                    ...
                    <td valign="middle" align="left" style="padding-left:10px; padding-right: 10px; width: 100%; ">
                          <asp:LinkButton ID="LinkButton1" runat="server" Text='<%# Eval("Subject") %>' CommandArgument='<%# Eval("NID") %>'></asp:LinkButton>
                    </td>
                    <td valign="middle" align="left" style="padding-left:10px; padding-right: 10px; ">
                          <asp:LinkButton ID="LinkButton2" runat="server" Text='<%# FormatHelper.ToNormalDate((DateTime)Eval("AddedDate")) %>' CommandArgument='<%# Eval("NID") %>'></asp:LinkButton>
                    </td>
                    </tr>
                </ItemTemplate>
...
<div class="row" style="min-height: 400px;" >
	...
	<div class="span12">
        ...
        CssClass="btn e"  Width="150px" onclick="btnDelete_Click"/>
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:Button ID="Button2" runat="server" Text="Ask A Question"
        CssClass="btn e"  Width="150px" onclick="btnAsk_Click"/>
...
<div class="row" style="min-height: 400px;" >
	...
	<div class="span12">
        ...
        <asp:Button ID="Button7" runat="server" Text="Submit Question"
        CssClass="btn e"  Width="150px" onclick="Button7_Click" />
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
