<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddChildCtl.ascx.cs" Inherits="GRA.SRP.Controls.AddChildCtl" %>
...
<div class="container">
    <div class="form-wrapper form-wide">
	      <h3 class="title-divider">
              <asp:Label ID="Label1" runat="server" Text="Add Child Account"></asp:Label>
          </h3>
          <hr>    
    ...
    <table style="font-weight: bold;  ">
        ...
        <tr>
            ...
            <td> 
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" CssClass="MessageFailure"
        ...
        <tr  >
            ...
            <td> 
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" Enabled='True'
              ...
              <asp:CompareValidator ID="CompareValidator1" runat="server" Enabled='True'
                        ControlToValidate="ProgID" Display="Dynamic" ErrorMessage="Program is required" 
              SetFocusOnError="True" Font-Bold="True" Operator="GreaterThan" ValueToCompare="0"><font color='red'> * Required </font></asp:CompareValidator>            </td>
        <tr/>
                ...
                <script language="javascript" type="text/javascript">
                    ...
                    $('#ddAvatar').ddslick({
                        ...
                        onSelected: function (data) {
                            $('#MainContent_FamilyAccountCtl1_rptr_AvatarID_0').val(data.selectedData.value);
                        }
                    });
                </script>
            </td>
        ...
        <tr  style='display: <%# ((bool)Eval("SchoolGrade_Show")? "normal" : "none") %>'>
            <td>School Grade:&nbsp;&nbsp;&nbsp;</td>
            <td> 
                 <asp:TextBox ID="SchoolGrade" runat="server" Text='<%# Eval("SchoolGrade") %>' Enabled='<%# (bool)Eval("SchoolGrade_Edit") %>'
        ...
        <tr  style='display: <%# ((bool)Eval("SDistrict_Show")? "normal" : "none") %>'>
            ...
            <td> 
                ...
                <asp:TextBox ID="SDistrictTxt" runat="server" Text='<%# ((int) Eval("SDistrict") == 0 ? "" : Eval("SDistrict")) %>' 
                     ...
                     Visible="false"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator71" runat="server" Enabled='<%# Eval("SDistrict_Req") %>'
                    ControlToValidate="SDistrict" Display="Dynamic" ErrorMessage="School District is required" 
                    SetFocusOnError="True" Font-Bold="True"><font color='red'> * Required </font></asp:RequiredFieldValidator>
               <asp:CompareValidator ID="CompareValidator31" runat="server" Enabled='<%# Eval("SDistrict_Req") %>'
                        ControlToValidate="SDistrict" Display="Dynamic" ErrorMessage="School District is required" 
                        SetFocusOnError="True" Font-Bold="True" Operator="GreaterThan" ValueToCompare="0"><font color='red'> * Required </font></asp:CompareValidator>
        ...
        <tr  style='display: <%# ((bool)Eval("SchoolName_Show")? "normal" : "none") %>'>
            ...
            <td> 
                ...
                <asp:RequiredFieldValidator ID="rfvSchoolName" runat="server" Enabled='<%# Eval("SchoolName_Req") %>'
                    ...
                    SetFocusOnError="True" Font-Bold="True"><font color='red'> * Required </font></asp:RequiredFieldValidator>
               <asp:CompareValidator ID="CompareValidator3" runat="server" Enabled='<%# Eval("SchoolName_Req") %>'
                        ControlToValidate="SchoolName" Display="Dynamic" ErrorMessage="School Name is required" 
                        SetFocusOnError="True" Font-Bold="True" Operator="GreaterThan" ValueToCompare="0"><font color='red'> * Required </font></asp:CompareValidator>
