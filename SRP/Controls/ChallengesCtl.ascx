    ...
    <div class="row hidden-print margin-1em-top margin-1em-bottom">
        <div class="col-xs-12 margin-halfem-top">
            ...
            <asp:TextBox
                ID="SearchText"
                runat="server"
                placeholder="Enter text here to search challenges, try a word or phrase"
        ...
        <div class="col-xs-12">
            <div class="pull-right margin-halfem-top" style="display: inline-block;">
                <asp:Button ID="btnFilter"
                    runat="server"
                    Text="challenges-search-button"
                    OnClick="btnFilter_Click"
                    CssClass="btn btn-success hidden-print" />
                <asp:Button ID="btnClear"
                    runat="server"
                    Text="challenges-search-clear-button"
                    OnClick="btnClear_Click"
                    CssClass="btn btn-primary hidden-print" />
            </div>
        </div>
    </div>
    <div class="row">
