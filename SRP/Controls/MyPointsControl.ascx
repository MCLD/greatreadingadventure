...
<p><asp:HyperLink runat="server" NavigateUrl="~/Account/ActivityHistory.aspx">I have <asp:Label ID="lblPoints" runat="server" Text="Label"></asp:Label> points.</asp:HyperLink></p>
