    ...
    <div class="form-wrapper form-wide">
        ...
        <asp:Repeater ID="rptr" runat="server"
            ...
            <ItemTemplate>
                ...
                <asp:HyperLink ID="FamilyAccountList" CausesValidation="false" CommandName="familyAccountList" CssClass="btn btn-default" runat="server" Text="Family Members" NavigateUrl="~/Account/FamilyAccountList.aspx"></asp:HyperLink>
                <asp:Button ID="btnSave" runat="server" Text="MyAccount SaveBtn" CommandName="save" CausesValidation="True" CssClass="btn btn-default" />
                &nbsp;
                <asp:Button ID="btn" runat="server" Text="Add Child Account" CommandName="childadd" CausesValidation="false" CssClass="btn btn-default"
                    Visible='<%# CanAddChildAccounts(Eval("DOB").ToString(), Eval("Age").ToString()) %>' />

                <a href="ChangePassword.aspx" class="btn btn-default">Change Password</a>

                <table class="margin-1em-top">
                                ...
                                $().ready(function() {
                                    $('#ddAvatar').ddslick({
                                        ...
                                        onSelected: function (data) {
                                            console.log(data);
                                            $('#ctl00$MainContent$MyAccountCtl1$rptr$ctl00$AvatarID').val(data.selectedData.value);
                                        }
                                    });
                                });
                            </script>
