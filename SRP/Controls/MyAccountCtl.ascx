<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyAccountCtl.ascx.cs" Inherits="STG.SRP.Controls.MyAccountCtl" %>
...
<div class="container">
    <div class="form-wrapper form-wide">
	      <h3 class="title-divider">
              <asp:Label ID="Label1" runat="server" Text="MyAccount Title"></asp:Label>
          </h3>
          <hr>    
    ...
    <table style="font-weight: bold;">
        ...
        <tr  style='display: <%# ((bool)Eval("MiddleName_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label2" runat="server" Text="Registration label MiddleName"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("LastName_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label3" runat="server" Text="Registration label LastName"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr>
            <td><asp:Label ID="Label4" runat="server" Text="Registration label Avatar"></asp:Label></td>
            <td>
                ...
                <script language="javascript" type="text/javascript">
                    ...
                    $('#ddAvatar').ddslick({
                        ...
                        onSelected: function (data) {
                            $('#MainContent_MyAccountCtl1_rptr_AvatarID_0').val(data.selectedData.value);
                        }
                    });
                </script>
            </td>
        ...
        <tr  style='display: <%# ((bool)Eval("SchoolGrade_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label5" runat="server" Text="Registration label School Grade"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("DOB_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label6" runat="server" Text="Registration label DOB"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("Age_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label7" runat="server" Text="Registration label Age"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("Gender_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label8" runat="server" Text="Registration label Gender"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td>                 
        ...
        <tr  style='display: <%# ((bool)Eval("EmailAddress_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label9" runat="server" Text="Registration label Email"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("PhoneNumber_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label10" runat="server" Text="Registration label Phone"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("StreetAddress1_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label12" runat="server" Text="Registration label Addr1"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("StreetAddress2_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label13" runat="server" Text="Registration label Addr2"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("City_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label14" runat="server" Text="Registration label City"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
                <asp:TextBox ID="City" runat="server" Text='<%# Eval("City") %>' Enabled='<%# (bool)Eval("City_Edit") %>' 
                    AutoPostBack="true" ontextchanged="City_TextChanged"
                 ></asp:TextBox>
        ...
        <tr  style='display: <%# ((bool)Eval("State_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label15" runat="server" Text="Registration label State"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("ZipCode_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label16" runat="server" Text="Registration label Zip"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("Country_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label17" runat="server" Text="Registration label Country"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("County_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label18" runat="server" Text="Registration label County"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("ParentGuardianFirstName_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label19" runat="server" Text="Registration label PGFN"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("ParentGuardianMiddleName_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label20" runat="server" Text="Registration label PGMN"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("ParentGuardianLastName_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label21" runat="server" Text="Registration label PGLN"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("Teacher_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label25" runat="server" Text="Registration label Teacher"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
        ...
        <tr  style='display: <%# ((bool)Eval("GroupTeamName_Show")? "normal" : "none") %>'>
            <td><asp:Label ID="Label27" runat="server" Text="Registration label Group"></asp:Label>&nbsp;&nbsp;&nbsp;</td>
            <td> 
       ...
       <tr  style='display: <%# ((bool)Eval("Custom5_Show") && CustomRegistrationFields.FetchObject().DDValues5 != "" ? "normal" : "none") %>'>
        ...
        <tr >
            <td colspan="2" align="center" >
                ...
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="btn" runat="server" Text="Add Child Account" CommandName="childadd" CausesValidation="false"  CssClass="btn a"
                    Visible='<%# CanAddChildAccounts(Eval("DOB").ToString(), Eval("Age").ToString()) %>'
                />
