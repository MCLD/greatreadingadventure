                    ...
                    <div style="padding: 50px; background-color: #f0f3f9; vertical-align: middle; text-align: center; width: 950px;">
                        <center>
                            <fieldset style="border-color: #FF6600; border-style: solid; padding-left: 10px; padding-right: 10px; width: 380px;">
                                <legend class="Message" style="font-size: 10pt; font-weight: bold; padding-left: 5px; padding-right: 5px;">Database Setup
                                </legend>
                                        ...
                                        <tr>
                                            <td>
                                                <table border="0" cellpadding="0">
                                                    ...
                                                    <tr>
                                                        <td align="left">Application Database Server/IP:<br />
                                                    ...
                                                    <tr>
                                                        <td align="left">Application Database Name:<br />
