...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <b>Organization: <asp:Label ID="lblOrg" runat="server" Text=""></asp:Label></b>
    ...
    <asp:DetailsView ID="dv" runat="server" DataSourceID="odsSRPUser" 
		...
		<EditItemTemplate>
                ...
                <asp:RegularExpressionValidator ID="revStrength" runat="server" 
                    ...
                    ValidationExpression="(?=^.{7,}$)(?=.*\d)(?=.*[a-zA-Z]+)(?![.\n]).*$" SetFocusOnError="False" Font-Bold="True" Enabled=false> * Strength
                </asp:RegularExpressionValidator>
                </EditItemTemplate>
                <InsertItemTemplate>
                    <asp:TextBox ID="Password" runat="server" Text='<%# Bind("Password") %>'  TextMode="Password"></asp:TextBox>
...
<div style="height: 150px; width: 100%; overflow: auto; border: solid 0px red; border: solid 1px #dddddd; ">
            ...
            <asp:GridView ID="gvUserGroups" ShowHeader=false  runat="server" DataSourceID="odsUserGroups" AutoGenerateColumns="false" Width="100%">
                <Columns>
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="isMember" Checked='<%# (((int)Eval("Checked")).ToString()=="1"?true:false) %>' runat="server" />   <%# Eval("GroupName")%>
