...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="margin-halfem-top">
        <asp:Button ID="btnFilter" runat="server" Text="Filter"
            OnClick="btnFilter_Click" Width="150px" CssClass="btn btn-lg btn-success" />

        &nbsp;<asp:Button ID="btnClear" runat="server" Text="Clear"
            OnClick="btnClear_Click" Width="150px" CssClass="btn btn-lg btn-default" />
    </div>
    <hr />
    <asp:ObjectDataSource ID="odsSearch" runat="server"
        ...
        <SelectParameters>
            ...
            <asp:SessionParameter DefaultValue="" Name="searchLibraryId" SessionField="PS_LibraryId" Type="Int32" />
            <asp:SessionParameter DefaultValue="" Name="searchLibraryDistrictId" SessionField="PS_LibraryDistrictId" Type="Int32" />
        </SelectParameters>
