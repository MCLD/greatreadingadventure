...
<table width="100%">
    ...
    <tr>
        <td colspan="6" height="200px">
            <b>Patron Preamble:</b><br />
                <CKEditor:CKEditorControl ID="Preamble" 
                        BasePath="/ckeditor/" 
                        runat="server" 
                        Skin="office2003" 
                        BodyId="wrapper" 
    ...
    <tr>
        <td align="left"><b>Is A Scorable Test/Survey:</b></td><td> <%# ((bool)Eval("CanBeScored")) %></td>
        <td align="right"><b># Times Taken:</b></td><td>0<%# ((int) Eval("TakenCount") ==0 ? "" : Eval("TakenCount")) %></td>
        <td align="right"><b># Patrons Who Took It:</b></td><td>0<%# ((int) Eval("PatronCount") ==0 ? "" : Eval("PatronCount")) %></td>
    </tr>
    <tr><td colspan="6"><hr /></td></tr>
