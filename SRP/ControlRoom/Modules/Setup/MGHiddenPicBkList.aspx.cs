...
{
    public partial class MGHiddenPicBkList : BaseControlRoomPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MasterPage.PageTitle = string.Format("{0}", "Background/Coloring Pages List");
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["MGID"] != null)
                {
                    ...
                    var o2 = MGHiddenPic.FetchObjectByParent(int.Parse(lblMGID.Text));
                    lblHPID.Text = o2.HPID.ToString();
