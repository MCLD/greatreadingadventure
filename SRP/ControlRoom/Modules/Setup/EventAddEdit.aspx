            ...
            <EditItemTemplate>
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="EventDate" runat="server" Width="75px"                         
                                Text='<%# (Eval("EventDate").ToString()=="" ? "" : DateTime.Parse(Eval("EventDate").ToString()).ToShortDateString().Replace("1/1/0001","") ) %>'
                                ></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="ceEventDate" runat="server" TargetControlID="EventDate">
                            </ajaxToolkit:CalendarExtender>
                            <ajaxToolkit:MaskedEditExtender ID="meEventDate" runat="server" 
                        ...
                        <td>
                            <asp:TextBox ID="EndDate" runat="server" Width="75px"                         
                                Text='<%# (Eval("EndDate").ToString()== "" ? "" : DateTime.Parse(Eval("EndDate").ToString()).ToShortDateString().Replace("1/1/0001","") ) %>'
                                ></asp:TextBox>
                            <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="EndDate">
                            </ajaxToolkit:CalendarExtender>
                            <ajaxToolkit:MaskedEditExtender ID="MaskedEditExtender1" runat="server" 
                    ...
                    <tr>
                        <td  nowrap> <b> Secret Code: </b> </td>
                        <td >
                            <asp:TextBox ID="SecretCode" runat="server"  Text='<%# Eval("SecretCode") %>'   Width="250"></asp:TextBox> <%# Eval("SecretCode").ToString() != "" ? CheckDups(Eval("SecretCode").ToString(), (int)Eval("EID")) :"" %>
                        </td>
                        <td  nowrap> <b> Number Points: </b> </td>
                        <td >
                    ...
                    <tr>
                        <td nowrap> <b> Custom 1: </b> </td>
                        <td> <uc1:EvtCustFldCtl ID="Custom1" runat="server" FieldNumber="1" Value='<%# Eval("Custom1") %>'  /> </td>

                        <td  nowrap> <b> Custom 2: </b> </td>
                        <td> <uc1:EvtCustFldCtl ID="Custom2" runat="server" FieldNumber="2" Value='<%# Eval("Custom2") %>'  /> </td>

                        <td nowrap> <b> Custom 3: </b> </td>
                        <td> <uc1:EvtCustFldCtl ID="Custom3" runat="server" FieldNumber="3" Value='<%# Eval("Custom3") %>'  /> </td>
