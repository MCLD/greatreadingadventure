<%@ Page Language="C#" MasterPageFile="~/ControlRoom/Control.Master"
    AutoEventWireup="true" CodeBehind="MGWordMatchAddEdit.aspx.cs" Inherits="GRA.SRP.ControlRoom.Modules.Setup.MGWordMatchAddEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="dv" runat="server" DataSourceID="odsData"
        ...
        <Fields>
            ...
            <asp:TemplateField HeaderText="Admin Name: " SortExpression="AdminName" HeaderStyle-Wrap="False">
                <EditItemTemplate>
                    <asp:TextBox ID="WMID" runat="server" Visible="False" Text='<%# Eval("WMID") %>'></asp:TextBox>
                    ...
                    <asp:Button ID="btnMore" runat="server"
                        Text="Images Setup" CssClass="btn-sm btn-purple"
            ...
            <asp:TemplateField HeaderText="# Choices To Choose From: " SortExpression="NumOptionsToChooseFrom" HeaderStyle-Wrap="False">
                <EditItemTemplate>
                    <asp:TextBox ID="NumOptionsToChooseFrom" runat="server" Text='<%# ((int) Eval("NumOptionsToChooseFrom") ==0 ? "" : Eval("NumOptionsToChooseFrom")) %>'
                        ReadOnly="False" Width="50px" CssClass="align-right"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="rfvNumOptionsToChooseFrom" runat="server"
                        ControlToValidate="NumOptionsToChooseFrom" Display="Dynamic" ErrorMessage="# Choices To Choose From"
                        SetFocusOnError="True" Font-Bold="True"><font color='red'> * Required </font></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="revNumOptionsToChooseFrom"
                        ControlToValidate="NumOptionsToChooseFrom"
                        ValidationExpression="\d+"
                        Display="Dynamic"
                        EnableClientScript="true"
                        ErrorMessage="<font color='red'># Choices To Choose From must be numeric.</font>"
                        runat="server"
                        Font-Bold="True" Font-Italic="True"
                        Text="<font color='red'> * # Choices To Choose From must be numeric. </font>"
                        EnableTheming="True"
                        SetFocusOnError="True" />
                    <asp:RangeValidator ID="rvNumOptionsToChooseFrom"
                        ControlToValidate="NumOptionsToChooseFrom"
                        MinimumValue="0"
                        MaximumValue="99"
                        Display="Dynamic"
                        Type="Integer"
                        EnableClientScript="true"
                        ErrorMessage="<font color='red'># Choices To Choose From must be from 0 to 99!</font>"
                        runat="server"
                        Font-Bold="True" Font-Italic="True"
                        Text="<font color='red'> * # Choices To Choose From must be from 0 to 99! </font>"
                        EnableTheming="True"
                        SetFocusOnError="True" />
                </EditItemTemplate>
                <HeaderStyle Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />
            ...
            <asp:TemplateField ShowHeader="False">
                ...
                <EditItemTemplate>
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server"
                        ...
                        CommandName="more"
                        CommandArgument='<%# Eval("MGID") %>'
                        ImageUrl="~/ControlRoom/Images/images.png"
                        Height="35"
    ...
    <asp:ObjectDataSource ID="odsData" runat="server"
        ...
        TypeName="GRA.SRP.DAL.MGWordMatch">
        <SelectParameters>
