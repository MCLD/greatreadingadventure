    ...
    <asp:DetailsView ID="dv" runat="server" DataSourceID="odsData"
       ...
       <asp:BoundField DataField="MGID" HeaderText="Game ID: " SortExpression="MGID" ReadOnly="True" InsertVisible="False">
        ...
        <asp:TemplateField HeaderText="Admin Name: " SortExpression="AdminName" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                <asp:TextBox ID = "CAID" runat="server" Visible="False" Text='<%# Eval("CAID") %>' ></asp:TextBox>
                ...
                <asp:Button ID="btnMore" runat="server" 
                	Text="Easy Slides Setup" CssClass="btn-sm btn-purple" Width="130px"
                    CommandArgument='<%# Eval("MGID") %>'
                	CommandName="Easy" 
                />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button1" runat="server" 
                	Text="Medium Slides Setup" CssClass="btn-sm btn-purple" Width="130px"
                    CommandArgument='<%# Eval("MGID") %>'
                	CommandName="Medium" 
                />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button2" runat="server" 
                	Text="Hard Slides Setup" CssClass="btn-sm btn-purple" Width="130px"
                    CommandArgument='<%# Eval("MGID") %>'
                	CommandName="Hard" 
                />
                &nbsp;&nbsp;&nbsp;
        ...
        <asp:TemplateField HeaderText="Game Name: " SortExpression="GameName" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                ...
                <asp:Button ID="btnPreview" runat="server" 
                	Text="Preview Game" CssClass="btn-sm btn-purple"  Width="130px"
                    CommandArgument='<%# Eval("MGID") %>'
                	CommandName="preview" 
                />
                &nbsp;&nbsp;&nbsp;
            ...
            <asp:TemplateField ShowHeader="False">
                ...
                <EditItemTemplate>
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" 
                        ...
                        CommandName="Easy" 
                        CommandArgument='<%# Eval("MGID") %>' 
                        ImageUrl="~/ControlRoom/Images/one.png" 
                        Height="35"
                        Text="Easy Slides"   Tooltip="Easy Slides"
                        AlternateText="Easy Slides" /> 
                    ...
                    <asp:ImageButton ID="ImageButton2" runat="server" 
                        ...
                        CommandName="Medium" 
                        CommandArgument='<%# Eval("MGID") %>' 
                        ImageUrl="~/ControlRoom/Images/four.png" 
                        Height="35"
                        Text="Medium Slides"   Tooltip="Medium Slides"
                        AlternateText="Medium Slides" /> 
                    ...
                    <asp:ImageButton ID="ImageButton3" runat="server" 
                        ...
                        CommandName="Hard" 
                        CommandArgument='<%# Eval("MGID") %>' 
                        ImageUrl="~/ControlRoom/Images/nine.png" 
                        Height="35"
                        Text="Hard Slides"   Tooltip="Hard Slides"
                        AlternateText="Hard Slides" /> 
