<%@ Page Language="C#" MasterPageFile="~/ControlRoom/Control.Master" 
    AutoEventWireup="true" CodeBehind="MGHiddenPicAddEdit.aspx.cs" Inherits="STG.SRP.ControlRoom.Modules.Setup.MGHiddenPicAddEdit" 
    ...
    <asp:DetailsView ID="dv" runat="server" DataSourceID="odsData"
       ...
       <asp:BoundField DataField="MGID" HeaderText="Game ID: " SortExpression="MGID" ReadOnly="True" InsertVisible="False">
        ...
        <asp:TemplateField HeaderText="Admin Name: " SortExpression="AdminName" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                <asp:TextBox ID = "HPID" runat="server" Visible="False" Text='<%# Eval("HPID") %>' ></asp:TextBox>
                ...
                <asp:Button ID="btnMore" runat="server" 
                	Text="Backgrounds Setup" CssClass="btn-sm btn-purple"
        ...
        <asp:TemplateField HeaderText="Easy Dictionary: " SortExpression="EasyDictionary" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                <%# CountTerms(Eval("EasyDictionary").ToString())%>
                <asp:TextBox ID="EasyDictionary" runat="server" Text='<%# Eval("EasyDictionary") %>' 
                     ReadOnly="False" Width="100%" TextMode="MultiLine" Rows="5"></asp:TextBox>
            </EditItemTemplate>
            <HeaderStyle Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />    
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Medium Dictionary: " SortExpression="MediumDictionary" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
            <%# CountTerms(Eval("MediumDictionary").ToString())%>
                <asp:TextBox ID="MediumDictionary" runat="server" Text='<%# Eval("MediumDictionary") %>' 
                     ReadOnly="False" Width="100%" TextMode="MultiLine" Rows="5"></asp:TextBox>
            </EditItemTemplate>
            <HeaderStyle Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />    
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Hard Dictionary: " SortExpression="HardDictionary" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
            <%# CountTerms(Eval("HardDictionary").ToString())%>
                <asp:TextBox ID="HardDictionary" runat="server" Text='<%# Eval("HardDictionary") %>' 
                     ReadOnly="False" Width="100%" TextMode="MultiLine" Rows="5"></asp:TextBox>
            </EditItemTemplate>
            <HeaderStyle Font-Bold="True" HorizontalAlign="Right" VerticalAlign="Top" />    
        </asp:TemplateField>
...
&nbsp;
	...
	<asp:ObjectDataSource ID="odsData" runat="server" 
        ...
        TypeName="STG.SRP.DAL.MGHiddenPic">
        <SelectParameters>
