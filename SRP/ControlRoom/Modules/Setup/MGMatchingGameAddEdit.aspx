...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:DetailsView ID="dv" runat="server" DataSourceID="odsData"
        ...
        <asp:TemplateField HeaderText="Admin Name: " SortExpression="AdminName" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                 <asp:TextBox ID = "MAGID" runat="server" Visible="False" Text='<%# Eval("MAGID") %>' ></asp:TextBox>
                ...
                <asp:Button ID="btnMore" runat="server" 
                	Text="Tiles Setup" CssClass="btn-sm btn-purple"
        ...
        <asp:TemplateField HeaderText="Easy Game Grid Size: " SortExpression="EasyGameSize" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                <asp:DropDownList ID="EasyGameSize" runat="server" Width="100px"
                    >
        ...
        <asp:TemplateField HeaderText="Medium Game Grid Size: " SortExpression="MediumGameSize" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                <asp:DropDownList ID="MediumGameSize" runat="server" Width="100px"
                    >
                    <asp:ListItem Value="2" Text="2"></asp:ListItem>
                    <asp:ListItem Value="4" Text="4"></asp:ListItem>
                    <asp:ListItem Value="6" Text="6"></asp:ListItem>
                </asp:DropDownList>
                <asp:Label ID="MediumGameSizeLbl" runat="server" Text='<%# Eval("MediumGameSize") %>' Visible="False"></asp:Label>
        ...
        <asp:TemplateField HeaderText="Hard Game Grid Size: " SortExpression="HardGameSize" HeaderStyle-Wrap="False">
		    <EditItemTemplate>
                <asp:DropDownList ID="HardGameSize" runat="server" Width="100px"
                    >
                    <asp:ListItem Value="2" Text="2"></asp:ListItem>
                    <asp:ListItem Value="4" Text="4"></asp:ListItem>
                    <asp:ListItem Value="6" Text="6"></asp:ListItem>
