...
{
    public partial class MGOnlineBookPagesList : BaseControlRoomPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MasterPage.PageTitle = string.Format("{0}", "Online Book Pages");
            ...
            if (!IsPostBack)
            {
                ...
                if (Session["MGID"] != null)
                {
                    ...
                    var o2 = MGOnlineBook.FetchObjectByParent(int.Parse(lblMGID.Text));
                    lblOBID.Text = o2.OBID.ToString();
