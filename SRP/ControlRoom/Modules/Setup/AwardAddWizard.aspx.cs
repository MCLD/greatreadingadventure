...
namespace STG.SRP.ControlRoom.Modules.Setup
{
    public partial class AwardAddWizard : BaseControlRoomPage
    {
        ...
        protected string CoalesceBadges()
        {
            ...
            if (badgesList.Length > 0) badgesList = badgesList.Substring(1, badgesList.Length - 1);
        ...
        private Badge LoadBadgeObject()
        {
            ...
            obj.CustomEarnedMessage = CustomEarnedMessage.Text;
