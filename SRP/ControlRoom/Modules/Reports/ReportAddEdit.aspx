                ...
                <InsertItemTemplate>
                    ...
                    <asp:Panel ID="pnlClickReg" runat="server" CssClass="pnlCSS">
                        ...
                        <div style="height: 30px; vertical-align: middle; background-color: #0066FF;" class="linearBg2">
                            ...
                            <div style="float: right; color: White; padding: 5px 5px 0 0">
                                <asp:Label ID="lblMessageReg" runat="server" Text="Label" />
                                &nbsp;<asp:Image ID="imgArrowsReg" runat="server" />
                            </div>
                    ...
                    <asp:Panel ID="pnlColReg" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Patron ID: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PIDInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Username: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="UsernameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td></td>
                            </tr>

                            <tr <%=ShowField("FirstName") %>>
                                <td><b>First Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="FirstNameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="FirstName" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("LastName") %>>
                                <td><b>Last Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="LastNameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="LastName" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr <%=ShowField("DOB") %>>
                                ...
                                <td align="center">
                                    <asp:CheckBox ID="DOBInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr <%=ShowField("Age") %>>
                                <td><b>Age: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="AgeInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                                <asp:TextBox ID="AgeFrom" runat="server" Text=''
                                    ReadOnly="False" Width="75px" CssClass="align-right"></asp:TextBox>
                                        ...
                                        <asp:RangeValidator ID="rvAgeFrom"
                                            ...
                                            Type="Integer"
                                            EnableClientScript="true"
                                            ErrorMessage="<font color='red'>AgeFrom must be from 0 to 200!</font>"
                                            runat="server"
                                            Font-Bold="True" Font-Italic="True"
                                            Text="<font color='red'> * AgeFrom must be from 0 to 200! </font>"
                                            EnableTheming="True"
                                            SetFocusOnError="True" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        To: &nbsp;
                                    <asp:TextBox ID="AgeTo" Width="75px" runat="server" Text=''></asp:TextBox>
                                        ...
                                        <asp:RangeValidator ID="rvAgeTo"
                                            ...
                                            Type="Integer"
                                            EnableClientScript="true"
                                            ErrorMessage="<font color='red'>Age To must be from 0 to 200!</font>"
                                            runat="server"
                                            Font-Bold="True" Font-Italic="True"
                                            Text="<font color='red'> * Age To must be from 0 to 200! </font>"
                                            EnableTheming="True"
                                            SetFocusOnError="True" />
                                    </b>
                                </td>
                            ...
                            <tr <%=ShowField("SchoolGrade") %>>
                                <td><b>School Grade: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SchoolGradeInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="SchoolGrade" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("Gender") %>>
                                <td><b>Gender: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="GenderInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("EmailAddress") %>>
                                <td><b>Email Address: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="EmailAddressInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="EmailAddress" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>


                            <tr <%=ShowField("PhoneNumber") %>>
                                <td><b>Phone Number: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PhoneNumberInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="PhoneNumber" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("City") %>>
                                <td><b>City: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="CityInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="City" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("State") %>>
                                <td><b>State: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="StateInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="State" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("ZipCode") %>>
                                <td><b>Zip Code: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ZipCodeInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="ZipCode" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("County") %>>
                                <td><b>County: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="CountyInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="County" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("District") %>>
                                <td><b>Library District: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="DistrictInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("PrimaryLibrary") %>>
                                <td><b>Library: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PrimaryLibraryInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("SchoolType") %>>
                                <td><b>School Type: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SchoolTypeInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("SDistrict") %>>
                                <td><b>School District: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SDistrictInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("SchoolName") %>>
                                <td><b>School Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SchoolNameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("Teacher") %>>
                                <td><b>Teacher: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="TeacherInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Teacher" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("GroupTeamName") %>>
                                <td><b>Group/Team Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="GroupTeamNameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="GroupTeamName" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>



                            <tr <%=ShowField("LiteracyLevel1") %>>
                                <td><b>LiteracyLevel1: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="LiteracyLevel1Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("LiteracyLevel2") %>>
                                <td><b>LiteracyLevel2: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="LiteracyLevel2Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr <%=ShowField("Custom1") %>>
                                <td><b>Custom1: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom1Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom1" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>


                            <tr <%=ShowField("Custom2") %>>
                                <td><b>Custom2: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom2Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom2" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("Custom3") %>>
                                <td><b>Custom3: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom3Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom3" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("Custom4") %>>
                                <td><b>Custom4: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom4Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom4" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr <%=ShowField("Custom5") %>>
                                <td><b>Custom5: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom5Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom5" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Registration Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="RegistrationDateInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlTestResults" runat="server" CssClass="pnlCSS">
                        ...
                        <div style="height: 30px; vertical-align: middle; background-color: #0066FF;" class="linearBg2">
                            ...
                            <div style="float: right; color: White; padding: 5px 5px 0 0">
                                <asp:Label ID="lblMessageTest" runat="server" Text="Label" />
                                &nbsp;<asp:Image ID="imgArrowsTest" runat="server" />
                            </div>
                            <div style="clear: both"></div>
                        </div>
                    ...
                    <asp:Panel ID="pnlColTestResults" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Score 1: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score1Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Score 2: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score2Inc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Score 1 %: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score1PctInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Score 2 %: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score2PctInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlClickLog" runat="server" CssClass="pnlCSS">
                        ...
                        <div style="height: 30px; vertical-align: middle; background-color: #0066FF;" class="linearBg2">
                            ...
                            <div style="float: right; color: White; padding: 5px 5px 0 0">
                                <asp:Label ID="lblMessageLog" runat="server" Text="Label" />
                                &nbsp;<asp:Image ID="imgArrowsLog" runat="server" />
                            </div>
                            <div style="clear: both"></div>
                        </div>
                    ...
                    <asp:Panel ID="pnlColLog" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Points: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PointsInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Secret Code Earned: </b></td>
                                <td align="center"></td>
                                <td>
                                    <asp:TextBox ID="EventCode" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>
                    ...
                    <asp:Panel ID="pnlClickBadge" runat="server" CssClass="pnlCSS">
                        ...
                        <div style="height: 30px; vertical-align: middle; background-color: #0066FF;" class="linearBg2">
                            ...
                            <div style="float: right; color: White; padding: 5px 5px 0 0">
                                <asp:Label ID="lblMessageBadge" runat="server" Text="Label" />
                                &nbsp;<asp:Image ID="imgArrowsBadge" runat="server" />
                            </div>
                            <div style="clear: both"></div>
                        </div>
                    ...
                    <asp:Panel ID="pnlColBadge" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:CheckBox ID="EarnedBadgeInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:CheckBox ID="PhysicalPrizeNameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="PhysicalPrizeEarned" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="center"></td>
                                <td>
                                    <asp:CheckBox ID="PhysicalPrizeRedeemed" runat="server" ReadOnly="False"></asp:CheckBox></td>
                            </tr>

                            <tr>
                                <td><b>Physical Prize Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PhysicalPrizeDateInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlClickRev" runat="server" CssClass="pnlCSS hidden">

                        <div style="height: 30px; vertical-align: middle; background-color: #0066FF;" class="linearBg2">
                            <div style="float: left; color: White; padding: 5px 5px 5px 5px">Review Information</div>
                            <div style="float: right; color: White; padding: 5px 5px 0 0">
                                <asp:Label ID="lblMessageRev" runat="server" Text="Label" />
                                &nbsp;<asp:Image ID="imgArrowsRev" runat="server" />
                            </div>
                            <div style="clear: both"></div>
                        </div>

                    </asp:Panel>
                    <asp:Panel ID="pnlColRev" runat="server" Height="0" CssClass="pnlCSS hidden">
                        <table>
                            <tr style="background-color: #dddddd; padding: 20px">
                                <td width="175px" style="padding-top: 10px; padding-bottom: 10px; padding-left: 5px;"><b>Report Field </b></td>
                                <td width="75px" align="center"><b>Display </b></td>
                            ...
                            <tr>
                                <td><b># Reviews: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="NumReviewsInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Title: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ReviewTitleInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="ReviewTitle" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Author: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ReviewAuthorInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="ReviewAuthor" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Review Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ReviewDateInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlClickDraw" runat="server" CssClass="pnlCSS hidden">

                        <div style="height: 30px; vertical-align: middle; background-color: #0066FF;" class="linearBg2">
                            <div style="float: left; color: White; padding: 5px 5px 5px 5px">Random Drawing Information</div>
                            <div style="float: right; color: White; padding: 5px 5px 0 0">
                                <asp:Label ID="lblMessageDraw" runat="server" Text="Label" />
                                &nbsp;<asp:Image ID="imgArrowsDraw" runat="server" />
                            </div>
                            <div style="clear: both"></div>
                        </div>

                    </asp:Panel>
                    <asp:Panel ID="pnlColDraw" runat="server" Height="0" CssClass="pnlCSS hidden">
                        <table>
                            <tr style="background-color: #dddddd; padding: 20px">
                                <td width="175px" style="padding-top: 10px; padding-bottom: 10px; padding-left: 5px;"><b>Report Field </b></td>
                                <td width="75px" align="center"><b>Display </b></td>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:CheckBox ID="RandomDrawingNameInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="RandomDrawingName" runat="server" Text='' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Random Drawing Number: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="RandomDrawingNumInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:CheckBox ID="RandomDrawingDateInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <asp:CheckBox ID="HasBeenDrawnInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:CheckBox ID="HasBeenDrawn" runat="server" ReadOnly="False"></asp:CheckBox></td>
                            </tr>

                            <tr>
                                <td><b>User has redeemed prize: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="HasRedeemendInc" runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:CheckBox ID="HasRedeemend" runat="server" ReadOnly="False"></asp:CheckBox></td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <%--<ajaxToolkit:CollapsiblePanelExtender
...
ScrollContents="false">
                    ...
                    <asp:Panel ID="pnlColReg" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Patron ID: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PIDInc" runat="server" Checked='<%# (bool)Eval("PIDInc") %>' ReadOnly="False"></asp:CheckBox></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Username: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="UsernameInc" runat="server" Checked='<%# (bool)Eval("UsernameInc") %>' ReadOnly="False"></asp:CheckBox></td>
                                <td></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>First Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="FirstNameInc" runat="server" Checked='<%# (bool)Eval("FirstNameInc") %>' ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="FirstName" runat="server" Text='<%# Eval("FirstName") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Last Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="LastNameInc" runat="server" Checked='<%# (bool)Eval("LastNameInc") %>' ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="LastName" runat="server" Text='<%# Eval("LastName") %>' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Date of Birth: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="DOBInc" Checked='<%# (bool)Eval("DOBInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Age: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="AgeInc" Checked='<%# (bool)Eval("AgeInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>School Grade: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SchoolGradeInc" Checked='<%# (bool)Eval("SchoolGradeInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="SchoolGrade" runat="server" Text='<%# Eval("SchoolGrade") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Gender: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="GenderInc" Checked='<%# (bool)Eval("GenderInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="Gender" runat="server">
                                        <asp:ListItem Value="" Text="[Any Gender]"></asp:ListItem>
                                        <asp:ListItem Value="M" Text="M - Male"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>Email Address: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="EmailAddressInc" Checked='<%# (bool)Eval("EmailAddressInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="EmailAddress" runat="server" Text='<%# Eval("EmailAddress") %>' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Phone Number: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PhoneNumberInc" Checked='<%# (bool)Eval("PhoneNumberInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="PhoneNumber" runat="server" Text='<%# Eval("PhoneNumber") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>City: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="CityInc" Checked='<%# (bool)Eval("CityInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="City" runat="server" Text='<%# Eval("City") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>State: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="StateInc" Checked='<%# (bool)Eval("StateInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="State" runat="server" Text='<%# Eval("State") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Zip Code: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ZipCodeInc" Checked='<%# (bool)Eval("ZipCodeInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="ZipCode" runat="server" Text='<%# Eval("ZipCode") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>County: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="CountyInc" Checked='<%# (bool)Eval("CountyInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="County" runat="server" Text='<%# Eval("County") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Library District: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="DistrictInc" Checked='<%# (bool)Eval("DistrictInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="District" runat="server" DataSourceID="odsDDLibSys" DataTextField="Code" DataValueField="CID"
                                        AppendDataBoundItems="True">
                                        <asp:ListItem Value="0" Text="[Select a Value]"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>Library: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PrimaryLibraryInc" Checked='<%# (bool)Eval("PrimaryLibraryInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="PrimaryLibrary" runat="server" DataSourceID="odsDDBranch" DataTextField="Code" DataValueField="CID"
                                        AppendDataBoundItems="True">
                                        <asp:ListItem Value="0" Text="[Select a Value]"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>School Type: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SchoolTypeInc" Checked='<%# (bool)Eval("SchoolTypeInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="SchoolType" runat="server" DataSourceID="odsSchoolType" DataTextField="Code" DataValueField="CID"
                                        AppendDataBoundItems="True">
                                        <asp:ListItem Value="0" Text="[Select a Value]"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>School District: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SDistrictInc" Checked='<%# (bool)Eval("SDistrictInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="SDistrict" runat="server" DataSourceID="odsDDSchSys" DataTextField="Code" DataValueField="CID"
                                        AppendDataBoundItems="True">
                                        <asp:ListItem Value="0" Text="[Select a Value]"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>School Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="SchoolNameInc" Checked='<%# (bool)Eval("SchoolNameInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="SchoolName" runat="server" DataSourceID="odsDDSchool" DataTextField="Code" DataValueField="CID"
                                        AppendDataBoundItems="True">
                                        <asp:ListItem Value="0" Text="[Select a Value]"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>Teacher: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="TeacherInc" Checked='<%# (bool)Eval("TeacherInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Teacher" runat="server" Text='<%# Eval("Teacher") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Group/Team Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="GroupTeamNameInc" Checked='<%# (bool)Eval("GroupTeamNameInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="GroupTeamName" runat="server" Text='<%# Eval("GroupTeamName") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>LiteracyLevel1: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="LiteracyLevel1Inc" Checked='<%# (bool)Eval("LiteracyLevel1Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr>
                                <td><b>LiteracyLevel2: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="LiteracyLevel2Inc" Checked='<%# (bool)Eval("LiteracyLevel2Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                            ...
                            <tr>
                                <td><b>Custom1: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom1Inc" Checked='<%# (bool)Eval("Custom1Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom1" runat="server" Text='<%# Eval("Custom1") %>' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Custom2: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom2Inc" Checked='<%# (bool)Eval("Custom2Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom2" runat="server" Text='<%# Eval("Custom2") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Custom3: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom3Inc" Checked='<%# (bool)Eval("Custom3Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom3" runat="server" Text='<%# Eval("Custom3") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Custom4: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom4Inc" Checked='<%# (bool)Eval("Custom4Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom4" runat="server" Text='<%# Eval("Custom4") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Custom5: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Custom5Inc" Checked='<%# (bool)Eval("Custom5Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="Custom5" runat="server" Text='<%# Eval("Custom5") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Registration Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="RegistrationDateInc" Checked='<%# (bool)Eval("RegistrationDateInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlColTestResults" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Score 1: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score1Inc" Checked='<%# (bool)Eval("Score1Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Score 2: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score2Inc" Checked='<%# (bool)Eval("Score2Inc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Score 1 %: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score1PctInc" Checked='<%# (bool)Eval("Score1PctInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Score 2 %: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="Score2PctInc" Checked='<%# (bool)Eval("Score2PctInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlColLog" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Points: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PointsInc" Checked='<%# (bool)Eval("PointsInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="EventCode" runat="server" Text='<%# Eval("EventCode") %>' Width="200px"></asp:TextBox></td>
                            </tr>
                    ...
                    <asp:Panel ID="pnlColBadge" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Earned Badge: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="EarnedBadgeInc" Checked='<%# (bool)Eval("EarnedBadgeInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:DropDownList ID="EarnedBadge" runat="server" DataSourceID="odsBadge" DataTextField="AdminName" DataValueField="BID"
                                        AppendDataBoundItems="True">
                                        <asp:ListItem Value="0" Text="[Select a Value]"></asp:ListItem>
                            ...
                            <tr>
                                <td><b>Physical Prize Earned: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PhysicalPrizeNameInc" Checked='<%# (bool)Eval("PhysicalPrizeNameInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="PhysicalPrizeEarned" runat="server" Text='<%# Eval("PhysicalPrizeEarned") %>' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="center"></td>
                                <td>
                                    <asp:CheckBox ID="PhysicalPrizeRedeemed" runat="server" Checked='<%# (bool)Eval("PhysicalPrizeRedeemed") %>' ReadOnly="False"></asp:CheckBox></td>
                            </tr>

                            <tr>
                                <td><b>Physical Prize Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="PhysicalPrizeDateInc" Checked='<%# (bool)Eval("PhysicalPrizeDateInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlColRev" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b># Reviews: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="NumReviewsInc" Checked='<%# (bool)Eval("NumReviewsInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>Title: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ReviewTitleInc" Checked='<%# (bool)Eval("ReviewTitleInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="ReviewTitle" runat="server" Text='<%# Eval("ReviewTitle") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Author: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ReviewAuthorInc" Checked='<%# (bool)Eval("ReviewAuthorInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="ReviewAuthor" runat="server" Text='<%# Eval("ReviewAuthor") %>' Width="200px"></asp:TextBox></td>
                            </tr>

                            <tr>
                                <td><b>Review Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="ReviewDateInc" Checked='<%# (bool)Eval("ReviewDateInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                    ...
                    <asp:Panel ID="pnlColDraw" runat="server" Height="0" CssClass="pnlCSS">
                        <table>
                            ...
                            <tr>
                                <td><b>Random Drawing Name: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="RandomDrawingNameInc" Checked='<%# (bool)Eval("RandomDrawingNameInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:TextBox ID="RandomDrawingName" runat="server" Text='<%# Eval("RandomDrawingName") %>' Width="200px"></asp:TextBox></td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Random Drawing Date: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="RandomDrawingDateInc" Checked='<%# (bool)Eval("RandomDrawingDateInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <b>From: &nbsp;
                        ...
                        To: &nbsp;
                            ...
                            <tr>
                                <td><b>User has been drawn: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="HasBeenDrawnInc" Checked='<%# (bool)Eval("HasBeenDrawnInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:CheckBox ID="HasBeenDrawn" runat="server" Checked='<%# (bool)Eval("HasBeenDrawn") %>' ReadOnly="False"></asp:CheckBox></td>
                            </tr>

                            <tr>
                                <td><b>User has redeemed prize: </b></td>
                                <td align="center">
                                    <asp:CheckBox ID="HasRedeemendInc" Checked='<%# (bool)Eval("HasRedeemendInc") %>' runat="server" ReadOnly="False"></asp:CheckBox></td>
                                <td>
                                    <asp:CheckBox ID="HasRedeemend" runat="server" Checked='<%# (bool)Eval("HasRedeemend") %>' ReadOnly="False"></asp:CheckBox></td>
                            </tr>
                        </table>
                    </asp:Panel>
                    <ajaxToolkit:CollapsiblePanelExtender
    ...
    <asp:ObjectDataSource ID="odsTemplate" runat="server"
        SelectMethod="GetAll"
        TypeName="GRA.SRP.DAL.ReportTemplate"></asp:ObjectDataSource>
