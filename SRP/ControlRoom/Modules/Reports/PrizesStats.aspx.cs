...
{
    public partial class PrizesStats : BaseControlRoomPage
    {
        ...
        private DataSet GetReportData()
        {
            ...
            var ds = SqlHelper.ExecuteDataset(conn, CommandType.StoredProcedure, "rpt_PrizeRecipients", arrParams);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string excelFilename = Server.MapPath("~/PhysicalPrizesReportResults.xlsx");
            CreateExcelFile.CreateExcelDocument(ds, excelFilename);

            Response.ContentType = "application/vnd.ms-excel";
            Response.AppendHeader("Content-Disposition", "attachment; filename=PhysicalPrizesReportResults.xlsx");
