...
{
    public partial class ChallengeIssues : BaseControlRoomPage
    {
        ...
        private const string ReportName = "Challenge Issues";
        private const string ReportStoredProcedure = "rpt_ChallengeIssues";
