...
{
    public partial class ReadingActivityReport : BaseControlRoomPage
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string excelFilename = Server.MapPath("~/ReadingActivityReport.xlsx");
            CreateExcelFile.CreateExcelDocument(ds, excelFilename);

            Response.ContentType = "application/vnd.ms-excel";
            Response.AppendHeader("Content-Disposition", "attachment; filename=ReadingActivityReport.xlsx");
