...
{
    public partial class LevelStats : BaseControlRoomPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                MasterPage.PageTitle = string.Format("{0}", "Game Level Statistics Report");
        ...
        private DataSet GetReportData()
        {
            ...
            var ds = SqlHelper.ExecuteDataset(conn, CommandType.StoredProcedure, "rpt_GameLevelStats", arrParams);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string excelFilename = Server.MapPath("~/GameLevelStatsReportResults.xlsx");
