...
CodeBehind="LevelStats.aspx.cs" Inherits="GRA.SRP.ControlRoom.Modules.Reports.LevelStats" 
    ...
    <table cellpadding="5" cellspacing="0" border="1" width="100%">
        ...
        <ItemTemplate>
            <tr style="font-weight: normal;">
                ...
                <td align="right"><%# FormatHelper.ToInt((int)Eval("LevelAchieved"))%></td>
                <td align="right"><%# FormatHelper.ToInt((int)Eval("FinisherCount"))%></td>  
