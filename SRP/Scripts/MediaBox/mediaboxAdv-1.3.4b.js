...
(function() {
    ...
    function setup(open) {
        ...
        try {
            // BJ
            //window.document.getElementById('fl').style.display = 'none';
            //window.document.getElementById('fl').style.visibility = 'hidden';
           // window.document.getElementById('fl').style.height = '0px';
        }
        catch (err) { };
    }
    ...
    function close() {
        ...
        try {
            // BJ
            //window.document.getElementById('fl').style.display = 'inline';
            //window.document.getElementById('fl').style.visibility = 'block';
           // window.document.getElementById('fl').style.height = '80px';

            
            //alert(window.document.getElementById('fl').style.display)
        }
        catch (err) { };
        return false;
    }
