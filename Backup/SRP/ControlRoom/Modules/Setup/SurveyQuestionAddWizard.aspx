...
<asp:Panel ID="pnlEnd" runat="server" DefaultButton="btnSave0" width="100%"  Visible="false"
   ...
   <table width="100%" height="100px">
        <tr>
            <td colspan="6" height="100%" valign="bottom">
                For these types of pseudo-questions there are no additional details.  Click Continue to save and return to the List of Questions.
                <hr />
            </td>
        </tr>
        <tr>
...
<asp:Panel ID="pnlType1" runat="server" 
    ...
    DefaultButton="btnSave1" width="100%" height="585px" Visible="false">
    <table width="100%" height="550px">
        <tr>
            <td height="400px"> <b> Instructions/Text/Description: </b> <br />
                            <CKEditor:CKEditorControl ID="QText" 
                                    BasePath="/ckeditor/" 
                                    runat="server" 
                                    Skin="office2003" 
                                    BodyId="wrapper" 
...
<asp:Panel ID="pnlType3" runat="server" 
    ...
    DefaultButton="btnSave3" width="100%" height="585px" Visible="false">
    <table width="100%" height="550px">
        <tr>
        ...
        <tr>
            <td height="400px" colspan="2"> <b> Question To Patron: </b> <br />
                            <CKEditor:CKEditorControl ID="QText3" 
                                    BasePath="/ckeditor/" 
                                    runat="server" 
                                    Skin="office2003" 
                                    BodyId="wrapper" 
...
<asp:Panel ID="pnlType2" runat="server" 
    ...
    DefaultButton="btnContinue2" width="100%" height="585px" Visible="false">
    <table width="100%" height="400px">
        ...
        <tr>
            <td height="300px" colspan="4"> <b> Question To Patron: </b> <br />
                            <CKEditor:CKEditorControl ID="QText2" 
                                    BasePath="/ckeditor/" 
                                    runat="server" 
                                    Skin="office2003" 
                                    BodyId="wrapper" 
...
<asp:Panel ID="pnlType4" runat="server" 
    ...
    DefaultButton="btnContinue4" width="100%" height="585px" Visible="false">
    <table width="100%" height="400px">
        <tr>
            <td> <b> Admin Description: </b> </td>
            <td colspan="3">
        ...
        <tr>
            <td height="300px" colspan="4"> <b> Question To Patron: </b> <br />
                            <CKEditor:CKEditorControl ID="QText4" 
                                    BasePath="/ckeditor/" 
                                    runat="server" 
                                    Skin="office2003" 
                                    BodyId="wrapper" 
...
<asp:Panel ID="pnlType2Answers" runat="server" 
    ...
    DefaultButton="btnSave22" width="100%" height="585px" Visible="false">
    <table width="100%" height="530px">
        ...
        <tr>
            <td><asp:TextBox ID="ChoiceText2" runat="server" Text='' ReadOnly="False" Width="250px"></asp:TextBox>
            ...
            <td><asp:CheckBox ID="AskClarification2" runat="server" ReadOnly="False"></asp:CheckBox></td>
            <td><asp:CheckBox ID="ClarificationRequired2" runat="server" ReadOnly="False"></asp:CheckBox></td>
            <td>
    ...
    <table width="100%">
        ...
        <ItemTemplate>
            ...
            <tr>
                ...
                <td ><asp:Button ID="btnAddAnswer2" runat="server" Text=" Delete "  CausesValidation="False" CommandArgument='<%# Eval("ChoiceOrder")%>' CommandName="delete"/></td>
            </tr>
...
<asp:Panel ID="pnlType4Answers" runat="server" 
    ...
    DefaultButton="btnSave44" width="100%" height="585px" Visible="false">
    <table width="100%" height="550px">
        <tr>
            <td> <b>Multiple Choice Answer: </b> </td>        
        </tr>
        ...
        <tr>
            <td><asp:TextBox ID="ChoiceText4" runat="server" Text='' ReadOnly="False" Width="250px"></asp:TextBox>
    ...
    <table width="100%">
        ...
        <tr>
            <td colspan="3"><asp:TextBox ID="LineText4" runat="server" Text='' ReadOnly="False" Width="600px"></asp:TextBox>
    ...
    <table width="100%">
        ...
        <ItemTemplate>
            ...
            <tr>
                ...
                <td ><asp:Button ID="btnDel4" runat="server" Text=" Delete "  CausesValidation="False" CommandArgument='<%# Eval("LineOrder")%>' CommandName="delete"/></td>
            </tr>
