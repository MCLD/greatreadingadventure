<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PatronCtl.ascx.cs" Inherits="STG.SRP.ControlRoom.Controls.PatronCtl" %>
    ...
    <table style="font-weight: bold;  width : 100%">
        ...
        <tr  style='display: <%# ((bool)Eval("DOB_Show")? "normal" : "none") %>'>
            ...
            <td> 
                ...
                <ajaxToolkit:CalendarExtender ID="ceEventDate" runat="server" TargetControlID="DOB">
                </ajaxToolkit:CalendarExtender>
                <ajaxToolkit:MaskedEditExtender ID="meEventDate" runat="server" 
                    UserDateFormat="MonthDayYear" TargetControlID="DOB" MaskType="Date" Mask="99/99/9999">
