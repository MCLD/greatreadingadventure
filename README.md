...
You can view the latest [release notes](https://github.com/MCLD/greatreadingadventure/releases/latest) or **[download the latest version (4.4.2)](https://github.com/MCLD/greatreadingadventure/releases/download/v4.4.2/GreatReadingAdventure-4.4.2.zip)**.
