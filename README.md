...
You can view the latest [release notes](https://github.com/MCLD/greatreadingadventure/releases/latest) or **[download the latest version (4.3.17)](https://github.com/MCLD/greatreadingadventure/releases/download/v4.3.17/GreatReadingAdventure-4.3.17.zip)**.
