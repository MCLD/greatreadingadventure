...
Version 4.1.1 (the last major release) was developed with the ASP.NET Core v2.2 runtime; version 4.1.0 used ASP.NET Core 2.1 and version 4.0.0 used ASP.NET Core 1.1.
