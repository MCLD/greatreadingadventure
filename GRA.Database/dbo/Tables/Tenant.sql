CREATE TABLE [dbo].[Tenant] (
    ...
    [NotificationsMenuText] VARCHAR (50)  CONSTRAINT [DF_Tenant_NotificationsMenuText] DEFAULT ('Notifications') NULL,
    [OffersMenuText]        VARCHAR (50)  CONSTRAINT [DF_Tenant_OffersMenuText] DEFAULT ('Offers') NULL,
    [BadgesMenuText]        VARCHAR (50)  CONSTRAINT [DF_Tenant_BadgesMenuText] DEFAULT ('Badges') NULL,
    [EventsMenuText]        VARCHAR (50)  CONSTRAINT [DF_Tenant_EventsMenuText] DEFAULT ('Events') NULL,
