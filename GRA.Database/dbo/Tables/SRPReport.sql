CREATE TABLE [dbo].[SRPReport] (
    ...
    [RegistrationDateStart]  DATETIME      CONSTRAINT [DF_SRPReport_RegistrationDateStart] DEFAULT (getdate()) NULL,
    [RegistrationDateEnd]    DATETIME      CONSTRAINT [DF_SRPReport_RegistrationDateEnd] DEFAULT (getdate()) NULL,
    [PointsMin]              INT           NULL,
    [PointsMax]              INT           NULL,
    ...
    [LastModDate]            DATETIME      CONSTRAINT [DF_SRPReport_LastModDate] DEFAULT (getdate()) NULL,
    [LastModUser]            VARCHAR (50)  CONSTRAINT [DF_SRPReport_LastModUser] DEFAULT ('N/A') NULL,
    [AddedDate]              DATETIME      CONSTRAINT [DF_SRPReport_AddedDate] DEFAULT (getdate()) NULL,
    [AddedUser]              VARCHAR (50)  CONSTRAINT [DF_SRPReport_AddedUser] DEFAULT ('N/A') NULL,
    ...
    CONSTRAINT [PK_SRPReport] PRIMARY KEY CLUSTERED ([RID] ASC)
);
